...
str = sprintf('Results for simple case');
disp(str);
% Here we are obtaining the scores for the logos. 
% Calculating Recall - how many are detected out of the actual present in
% the video
...
% str = sprintf('Results for 1st Pass - %d% Recall', round(pass_one_score_logo2));
% disp(str);
% str = sprintf('Results for 2nd Pass - %d% Recall', round(pass_two_score_logo2));
% disp(str);
